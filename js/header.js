...
class StyleSwitcher {
  constructor() {
    ...
    const isManualMode = StyleSwitcher.storage.getItem(
      StyleSwitcher._STORAGE_IS_MANUAL_MODE
    );
    if (isManualMode) {
      this._setActiveDayNight(
        StyleSwitcher.storage.getItem(StyleSwitcher._STORAGE_DAY_NIGHT) ||
          StyleSwitcher._getDefaultStyleDayNight()
      );
    } else {
      this._setActiveDayNight(StyleSwitcher._getDefaultStyleDayNight());
    }
    this._setActiveWide(
      StyleSwitcher.storage.getItem(StyleSwitcher._STORAGE_WIDE) === "true"
    );
  }
  static _setButtonText(btnClassName, text) {
    [...document.getElementsByClassName(btnClassName)].forEach(
      (ele) => (ele.innerHTML = text)
    );
  }
  _setActiveDayNight(style) {
    ...
    switch (style) {
      case StyleSwitcher._STYLE_DAY: {
        ...
        document.documentElement.classList.remove(
          StyleSwitcher._NIGHT_CLASS_ALT
        );
        break;
      }
    ...
    StyleSwitcher._setButtonText(
      "nightModeToggle",
      this.getDayNightButtonText(style)
    );
    StyleSwitcher.storage.setItem(
      StyleSwitcher._STORAGE_DAY_NIGHT,
  ...
  getDayNightClassNames() {
    switch (this.currentStylesheet) {
      case StyleSwitcher._STYLE_DAY:
        return "";
      case StyleSwitcher._STYLE_NIGHT:
        return StyleSwitcher._NIGHT_CLASS;
      case StyleSwitcher._STYLE_NIGHT_ALT:
        return [
          StyleSwitcher._NIGHT_CLASS,
          StyleSwitcher._NIGHT_CLASS_ALT,
        ].join(" ");
    }
  }
  ...
  cycleDayNightMode(direction) {
    const newStyle =
      direction === -1
        ? this.currentStylesheet === StyleSwitcher._STYLE_DAY
          ? StyleSwitcher._STYLE_NIGHT_ALT
          : this.currentStylesheet === StyleSwitcher._STYLE_NIGHT
          ? StyleSwitcher._STYLE_DAY
          : StyleSwitcher._STYLE_NIGHT
        : this.currentStylesheet === StyleSwitcher._STYLE_DAY
        ? StyleSwitcher._STYLE_NIGHT
        : this.currentStylesheet === StyleSwitcher._STYLE_NIGHT
        ? StyleSwitcher._STYLE_NIGHT_ALT
  ...
  _setActiveWide(isActive) {
    ...
    StyleSwitcher._setButtonText(
      "wideModeToggle",
      isActive ? "Disable Wide Mode" : "Enable Wide Mode (Experimental)"
    );
  ...
  getActiveWide() {
    return document.getElementById(StyleSwitcher._WIDE_ID) != null;
  }
}
...
class NavBar {
  ...
  static _initInstallPrompt() {
    ...
    window.addEventListener(
      "beforeinstallprompt",
      (e) => (NavBar._cachedInstallEvent = e)
    );
  }
  static initElements() {
    ...
    btnShowHide.onclick = () => {
      ...
      $(`.page__nav-hidden-mobile`).toggleClass(
        "block",
        $(btnShowHide).hasClass("active")
      );
    };
    ...
    addDivider(ulBooks);
    addLi(ulBooks, "book.html", "Player's Handbook", {
      aHash: "PHB",
      date: "2014",
    });
    addLi(ulBooks, "book.html", "Monster Manual", { aHash: "MM", date: null });
    addLi(ulBooks, "book.html", "Dungeon Master's Guide", {
      aHash: "DMG",
      date: null,
    });
    addDivider(ulBooks);
    addLi(ulBooks, "book.html", "Sword Coast Adventurer's Guide", {
      aHash: "SCAG",
      date: "2015",
    });
    addLi(ulBooks, "book.html", "Volo's Guide to Monsters", {
      aHash: "VGM",
      date: "2016",
    });
    addLi(ulBooks, "book.html", "Xanathar's Guide to Everything", {
      aHash: "XGE",
      date: "2017",
    });
    addLi(ulBooks, "book.html", "Mordenkainen's Tome of Foes", {
      aHash: "MTF",
      date: "2018",
    });
    addLi(ulBooks, "book.html", "Guildmasters' Guide to Ravnica", {
      aHash: "GGR",
      date: null,
    });
    addLi(ulBooks, "book.html", "Acquisitions Incorporated", {
      aHash: "AI",
      date: "2019",
    });
    addLi(ulBooks, "book.html", "Eberron: Rising from the Last War", {
      aHash: "ERLW",
      date: null,
    });
    addLi(
    ...
    addLi(ulBooks, "book.html", "Explorer's Guide to Wildemount", {
      aHash: "EGW",
      date: "2020",
    });
    addLi(ulBooks, "book.html", "Mythic Odysseys of Theros", {
      aHash: "MOT",
      date: null,
    });
    addLi(ulBooks, "book.html", "Tasha's Cauldron of Everything", {
      aHash: "TCE",
      date: null,
    });
    addDivider(ulBooks);
    addLi(ulBooks, "book.html", "Dungeon Master's Screen: Wilderness Kit", {
      aHash: "ScreenWildernessKit",
      date: "2020",
    });
    addDivider(ulBooks);
    addLi(ulBooks, "book.html", "Adventurers League", {
      aHash: "AL",
      date: "2016",
    });
    addLi(ulBooks, "book.html", "Sage Advice Compendium", {
      aHash: "SAC",
      date: "2019",
    });
    ...
    addLi(ulAdventures, "adventure.html", "Lost Mine of Phandelver", {
      isSide: true,
      aHash: "LMoP",
      date: "2014",
    });
    addLi(ulAdventures, "adventure.html", "Hoard of the Dragon Queen", {
      isSide: true,
      aHash: "HotDQ",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "Rise of Tiamat", {
      isSide: true,
      aHash: "RoT",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "Princes of the Apocalypse", {
      isSide: true,
      aHash: "PotA",
      date: "2015",
    });
    addLi(ulAdventures, "adventure.html", "Out of the Abyss", {
      isSide: true,
      aHash: "OotA",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "Curse of Strahd", {
      isSide: true,
      aHash: "CoS",
      date: "2016",
    });
    addLi(ulAdventures, "adventure.html", "Storm King's Thunder", {
      isSide: true,
      aHash: "SKT",
      date: null,
    });
    addLi(
      ...
      { isSide: true, aHash: "TftYP-TSC", date: "2017" }
    );
    addLi(
      ulAdventures,
      "adventure.html",
      "Tales from the Yawning Portal: The Forge of Fury",
      { isSide: true, aHash: "TftYP-TFoF", date: null }
    );
    addLi(
      ulAdventures,
      "adventure.html",
      "Tales from the Yawning Portal: The Hidden Shrine of Tamoachan",
      { isSide: true, aHash: "TftYP-THSoT", date: null }
    );
    addLi(
      ulAdventures,
      "adventure.html",
      "Tales from the Yawning Portal: White Plume Mountain",
      { isSide: true, aHash: "TftYP-WPM", date: null }
    );
    addLi(
      ulAdventures,
      "adventure.html",
      "Tales from the Yawning Portal: Dead in Thay",
      { isSide: true, aHash: "TftYP-DiT", date: null }
    );
    addLi(
      ulAdventures,
      "adventure.html",
      "Tales from the Yawning Portal: Against the Giants",
      { isSide: true, aHash: "TftYP-AtG", date: null }
    );
    addLi(
      ulAdventures,
      "adventure.html",
      "Tales from the Yawning Portal: Tomb of Horrors",
      { isSide: true, aHash: "TftYP-ToH", date: null }
    );
    addLi(ulAdventures, "adventure.html", "Tomb of Annihilation", {
      isSide: true,
      aHash: "ToA",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "The Tortle Package", {
      isSide: true,
      aHash: "TTP",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "Waterdeep: Dragon Heist", {
      isSide: true,
      aHash: "WDH",
      date: "2018",
    });
    addLi(ulAdventures, "adventure.html", "Lost Laboratory of Kwalish", {
      isSide: true,
      aHash: "LLK",
      date: null,
    });
    addLi(
      ...
      { isSide: true, aHash: "WDMM", date: null }
    );
    addLi(ulAdventures, "adventure.html", "Krenko's Way", {
      isSide: true,
      aHash: "KKW",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "Ghosts of Saltmarsh", {
      isSide: true,
      aHash: "GoS",
      date: "2019",
    });
    addLi(ulAdventures, "adventure.html", "Hunt for the Thessalhydra", {
      isSide: true,
      aHash: "HftT",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "The Orrery of the Wanderer", {
      isSide: true,
      aHash: "OoW",
      date: null,
    });
    addLi(
      ...
      { isSide: true, aHash: "DIP", date: null }
    );
    addLi(
      ulAdventures,
      "adventure.html",
      "Essentials Kit: Storm Lord's Wrath",
      { isSide: true, aHash: "SLW", date: null }
    );
    addLi(
      ulAdventures,
      "adventure.html",
      "Essentials Kit: Sleeping Dragon's Wake",
      { isSide: true, aHash: "SDW", date: null }
    );
    addLi(ulAdventures, "adventure.html", "Essentials Kit: Divine Contention", {
      isSide: true,
      aHash: "DC",
      date: null,
    });
    addLi(
      ...
      { isSide: true, aHash: "BGDIA", date: null }
    );
    addLi(ulAdventures, "adventure.html", "Locathah Rising", {
      isSide: true,
      aHash: "LR",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "Eberron: Forgotten Relics", {
      isSide: true,
      aHash: "EFR",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "Rick and Morty: Big Rick Energy", {
      isSide: true,
      aHash: "RMBRE",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "Infernal Machine Rebuild", {
      isSide: true,
      aHash: "IMR",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "Wildemount: Tide of Retribution", {
      isSide: true,
      aHash: "ToR",
      date: "2020",
    });
    addLi(ulAdventures, "adventure.html", "Wildemount: Dangerous Designs", {
      isSide: true,
      aHash: "DD",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "Wildemount: Frozen Sick", {
      isSide: true,
      aHash: "FS",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "Wildemount: Unwelcome Spirits", {
      isSide: true,
      aHash: "US",
      date: null,
    });
    addLi(ulAdventures, "adventure.html", "Theros: No Silent Secret", {
      isSide: true,
      aHash: "MOT-NSS",
      date: null,
    });
    addLi(
      ...
      { isSide: true, aHash: "IDRotF", date: null }
    );
    ...
    addLi(
      ulUtils,
      `https://wiki.dnd.d-n-k.tk/index.php/Page:_${NavBar.getCurrentPage().replace(
        /.html$/i,
        ""
      )}`,
      "Help",
    ...
    addButton(ulSettings, {
      html:
        styleSwitcher.getActiveWide() === true
          ? "Disable Wide Mode"
          : "Enable Wide Mode (Experimental)",
      click: (evt) => {
        evt.preventDefault();
    ...
    addButton(ulSettings, {
      ...
      click: async (evt) => {
        ...
        const dump = { sync: sync, async: async };
        DataUtil.userDownload("D&D//DNK", dump);
      },
      title:
        "Save any locally-stored data (loaded homebrew, active blacklists, DM Screen configuration,...) to a file.",
    });
    addButton(ulSettings, {
      ...
      title:
        "Load previously-saved data (loaded homebrew, active blacklists, DM Screen configuration,...) from a file.",
    });
    addDivider(ulSettings);
    addButton(ulSettings, {
      html: "Add as App",
    ...
    addButton(ulSettings, {
      ...
      click: async (evt) => {
        ...
        if (!navigator.serviceWorker || !navigator.serviceWorker.controller) {
          JqueryUtil.doToast(
            `The loader was not yet available! Reload the page and try again. If this problem persists, your browser may not support preloading.`
          );
          return;
        }
        ...
        const $dispProgress = $(
          `<div class="page__disp-download-progress-bar"/>`
        );
        const $dispPct = $(
          `<div class="page__disp-download-progress-text flex-vh-center bold">0%</div>`
        );
        const $btnCancel = $(
        ...
        messageChannel.port1.onmessage = (e) => {
          ...
          switch (msg.type) {
            case "download-progress": {
              if (NavBar._downloadBarMeta) {
                NavBar._downloadBarMeta.$dispProgress.css(
                  "width",
                  msg.data.pct
                );
            ...
            case "download-error": {
              if (NavBar._downloadBarMeta) {
                NavBar._downloadBarMeta.$wrpBar.addClass(
                  "page__wrp-download-bar--error"
                );
                NavBar._downloadBarMeta.$dispProgress.addClass(
                  "page__disp-download-progress-bar--error"
                );
                NavBar._downloadBarMeta.$dispPct.text("Error!");
                JqueryUtil.doToast(
                  `An error occurred. ${VeCt.STR_SEE_CONSOLE}`
                );
              }
              setTimeout(() => {
      ...
      title:
        "Preload the site data for offline use. Warning: slow. If it appears to freeze, cancel it and try again; progress will be saved.",
    });
    function addLi(appendTo, aHref, aText, opts) {
      ...
      if (opts.isSide) {
        li.onmouseenter = function () {
          NavBar.handleSideItemMouseEnter(this);
        };
      } else {
        li.onmouseenter = function () {
          NavBar.handleItemMouseEnter(this);
        };
        li.onclick = function () {
      ...
      a.innerHTML = `${
        opts.date !== undefined
          ? `<span class="ve-muted ve-small mr-2 page__nav-date inline-block text-right">${
              opts.date || ""
            }</span>`
          : ""
      }${aText}`;
    ...
    function addDropdown(appendTo, text, isSide = false) {
      ...
      a.onclick = function (event) {
        NavBar.handleDropdownClick(this, event, isSide);
      };
      if (isSide) {
        a.onmouseenter = function () {
          NavBar.handleSideDropdownMouseEnter(this);
        };
        a.onmouseleave = function () {
          NavBar.handleSideDropdownMouseLeave(this);
        };
      }
      a.innerHTML = `${text} <span class="caret ${
        isSide ? "caret--right" : ""
      }"></span>`;
      const ul = document.createElement("li");
      ul.className = `dropdown-menu ${
        isSide ? "dropdown-menu--side" : "dropdown-menu--top"
      }`;
  ...
  static highlightCurrentPage() {
    ...
    if (
      currentPage.toLowerCase() === "adventures.html" ||
      currentPage.toLowerCase() === "books.html"
    )
      isSecondLevel = true;
    ...
    try {
      ...
      if (current == null) {
        ...
        if (NavBar.ALT_CHILD_PAGES[currentPage])
          currentPage = NavBar.ALT_CHILD_PAGES[currentPage];
        current = document.querySelector(`li[data-page="${currentPage}"]`);
      }
      current.parentNode.childNodes.forEach(
        (n) => n.classList && n.classList.remove("active")
      );
      ...
      const setNearestParentActive = () => {
        while (
          closestLi !== null &&
          (closestLi.nodeName !== "LI" ||
            !closestLi.classList.contains("dropdown"))
        )
  ...
  static initHandlers() {
    NavBar._dropdowns = [
      ...document
        ...
        .querySelectorAll(`li.dropdown--navbar`),
    ];
  ...
  static handleItemMouseEnter(ele) {
    ...
    const timerIds = $ele
      ...
      .map((i, e) => ({ $ele: $(e), timerId: $(e).data("timer-id") }))
      .get();
    timerIds.forEach(({ $ele: $ele, timerId: timerId }) => {
...
window.addEventListener("load", () => {
  if (typeof [].flat !== "function") {
    ...
    const $btnClose = $(
      `<button class="btn btn-danger edge__btn-close"><span class="glyphicon glyphicon-remove"/></button>`
    ).click(() => {
      $overlay.remove();
      $body.removeClass("edge__body");
    });
    const $overlay = $(
      `<div class="flex-col flex-vh-center relative edge__overlay"/>`
    );
    $btnClose.appendTo($overlay);
    $overlay
      .append(
        `<div class="flex-col flex-vh-center">\n\t\t\t<div class="edge__title mb-2">UPDATE YOUR BROWSER</div>\n\t\t\t<div><i>It looks like you're using an outdated/unsupported browser.<br>\n\t\t\tD&D//DNK recommends and supports the latest <a href="https://www.google.com/chrome/" class="edge__link">Chrome</a> and the latest <a href="https://www.mozilla.org/firefox/" class="edge__link">Firefox</a>.</i></div>\n\t\t</div>`
      )
      .appendTo($body);
  }
});
